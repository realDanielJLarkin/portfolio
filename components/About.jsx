...
function About() {
    return (
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1.5 }} className='flex flex-col md:flex-row relative text-center md:text-left h-screen max-w-7xl px-10 justify-evenly mx-auto items-center'>
            ...
            <div className='relative top-24 md:static max-w-3xl mx-auto'>
                <p className='text-base tracking-wide '>Thanks for checking out my website! By now you know that I am a web developer with a passion for creating beautiful & responsive
